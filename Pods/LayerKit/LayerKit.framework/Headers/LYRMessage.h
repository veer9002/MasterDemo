 ...
 */
@property (nonatomic, readonly, nonnull) NSSet<LYRMessagePart *> *parts;
...
/**
 @abstract Local data related to the object.
 @discussion The `localData` is stored locally and will not be synchronized. It is also not queryable.
 */
@property (nonatomic, readonly, nullable) NSData *localData;

/**
 @abstract Sets additional data related to the message object and stores it locally.
 @param localData The object to assign to the message.
 @param error A pointer to an error that upon failure is set to an error object describing why setting failed.
 @return A Boolean value indicating if the request to delete the message was submitted for synchronization.
 */
- (BOOL)setLocalData:(nullable NSData *)localData error:(NSError * _Nullable * _Nullable)error __attribute__((swift_error(none)));
